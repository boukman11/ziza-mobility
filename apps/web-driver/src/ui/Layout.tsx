    ...
    <div className="appShell">
      <div className="topBar">
        <div style={{ display: "flex", gap: 10, alignItems: "center", flexWrap: "wrap" }}>
          <div style={{ fontWeight: 900, fontSize: 16 }}>Ziza • Driver</div>
      ...
      <div className="navRow">
        ...
        <NavItem to="/availability">Available trips</NavItem>
        <NavItem to="/active">Mission</NavItem>
        <NavItem to="/earnings">Earnings</NavItem>
